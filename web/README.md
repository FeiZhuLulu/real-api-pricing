...
- The Filters modal accepts an inclusive monthly budget range in USD. It filters all views by fixed subscription fee; metered APIs without a monthly fee are excluded while the range is active. The range is included in share links and CSV/table results follow it.
