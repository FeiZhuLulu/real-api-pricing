...
- **配色**：用明亮、干净的高饱和色，不用深灰或脏色。OpenAI 绿、Claude 橙、xAI 紫、Cursor 黄、Kimi 天蓝、GLM 黑、MiniMax 粉、Alibaba 红、OpenCode 青、DeepSeek 蓝、StepFun 电青 #00F4E5；Gemini 若入库用黄绿。前沿线用近黑色。
